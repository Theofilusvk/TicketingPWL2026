                ...
                <div class="card-body">
                    <form action="{{ route('reports.update', $report->report_id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('event_id') is-invalid @enderror" id="event_id" name="event_id" required>
                                @foreach($events as $event)
                                    <option value="{{ $event->event_id }}" {{ old('event_id', $report->event_id) == $event->event_id ? 'selected' : '' }}>{{ $event->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('report_type') is-invalid @enderror" id="report_type" name="report_type" value="{{ old('report_type', $report->report_type) }}" placeholder="e.g., Sales Summary">
